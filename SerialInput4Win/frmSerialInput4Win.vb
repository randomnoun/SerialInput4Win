...
'   (see http://msdn.microsoft.com/en-us/magazine/dd722812.aspx )

''' <summary>
''' The main UI for the SerialInput4Win application
''' </summary>
''' <remarks></remarks>
Public Class frmSerialInput4Win

    Private Declare Function GetForegroundWindow Lib "user32.dll" () As IntPtr

    Dim WithEvents serialPortReceiver As clsSerialPortReceiver
    Dim sendInputWrapper As New clsSendInputWrapper

    Dim strBuffer As String = ""
    Dim boolWasOpen As Boolean = False

    Private Sub serialPortReceiver_DataReceivedHandler(ByVal strText As String) Handles serialPortReceiver.DataRecieved
    ...
    Private Sub cmdApply_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdApply.Click
        ...
        If cmbPort.Enabled And cmbPort.SelectedItem IsNot Nothing Then
            ...
            boolWasOpen = True
            serialPortReceiver.Connect(cmbPort.SelectedItem, _
            ...
            MsgBox("Serial Input for Windows listening on " & cmbPort.SelectedItem)
        ...
        Else
            ...
            boolWasOpen = False
            strBuffer = ""
            MsgBox("Serial Input for Windows disabled")
    ...
    Private Sub frmSerialInput4Win_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        If serialPortReceiver.IsOpen Then serialPortReceiver.Disconnect()
    End Sub
